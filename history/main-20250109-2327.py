...
def on_press(key):
    ...
    if (pause_keys[0] in pressed_pause_keys) and (pause_keys[1] in pressed_pause_keys) and (pause_keys[2] in pressed_pause_keys):
        paused = not paused
        print("paused :", paused)
    if paused:
        return
...
pause_hotkey = '<ctrl>+<alt>+h' # toggle pause
